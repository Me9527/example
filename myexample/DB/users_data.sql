...
INSERT INTO `p_resources` (`ID`,`IDENTIFICATION`,`R_TYPE`,`ENABLE`,`DESCRIPTION`) VALUES (1,'/modules/module01/jsp/**','URL','Y','模块一下所有资源');
INSERT INTO `p_resources` (`ID`,`IDENTIFICATION`,`R_TYPE`,`ENABLE`,`DESCRIPTION`) VALUES (2,'/modules/module02/jsp/registration.jsp','URL','Y','模块二下用户注册页面');
